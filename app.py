...
# ======================================================
app = Flask(__name__)
APP_VERSION = "evoconprint-final-v1-2025-12-16"
...
# ======================================================
# GLOBAL ERROR HANDLER (NO GENERIC 500)
# ======================================================
...
def basic_auth_header():
    if not EVOCON_TENANT or not EVOCON_SECRET:
        raise RuntimeError("Missing EVOCON_TENANT or EVOCON_SECRET")
...
# ======================================================
def fetch_checklists_json(start_date, end_date):
    """
    Evocon expects date-only strings: YYYY-MM-DD
    """
...
def build_report(rows, shiftDate, shiftName):
    """
    Filter strictly by shiftDate + shift (Evocon is source of truth)
    Skip rows with result == Deleted
    """
    filtered = [
        r for r in rows
